...
export const SERVICE_SECTIONS: ServiceSectionData[] = [
  ...
  },
  {
    ...
    items: [
      { id: "s4-1", label: "Telegram 频道打包置顶", image: "/images/16.png" },
      { id: "s4-2", label: "Telegram 会员 - （14/3个月 18/6个月 31/一年）", image: "/images/16.png" },
      { id: "s4-3", label: "Telegram 炒群 60u/月）", image: "/images/16.png" },
      { id: "s4-4", label: "KOL 推广合作 (中文 / 海外)（10u/位）", image: "/images/17.png" },
      { id: "s4-5", label: "推特会员 - (130u / 年)", image: "/images/17.png" },
      { id: "s4-6", label: "币安广场 中 10-20u/位 - 英 10-15u/位", image: "/images/5.png" },
      ...
      { id: "s4-11", label: "社群活跃度维护与运营支持", image: "/images/24.png" },
    ]
  },
  {
    id: "section-5",
